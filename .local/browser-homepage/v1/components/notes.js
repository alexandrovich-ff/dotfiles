...
first_page_btns.innerHTML += '<div class="notes-launcher">Задачи</div>';
...
function addTask() {
    ...
    if (task.length > 0) {
        ...
        if (check !== null) {
            todo_input_msg.innerHTML = 'Эта задача уже существует';
        } else {
        ...
        todo_input_msg.innerHTML = "Не могу добавить пустое задание";
    }
}
...
function taskEditClick(parent_node) {
    ...
    save_btn.onclick = function () {
        ...
        if (new_name.length > 0) {
            if (check !== null) {
                error_field.innerHTML = 'Эта задача уже существует';
            } else {
            ...
            error_field.innerHTML = "Не могу добавить пустое задание";
        }
    };
}
